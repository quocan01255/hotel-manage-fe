                ...
                <div className="form-group ">
                    ...
                    <div className="form-date-from form-icon">
                        ...
                        <div className='input-container'>
                            <DatePicker  minDate={new Date()} dateFormat="dd/MM/yyyy" selected={startDate} onChange={(date) => setStartDate(date)} />
                    ...
                    <div className="form-date-to form-icon">
                        ...
                        <div className='input-container'>
                            <DatePicker minDate={startDate}  dateFormat="dd/MM/yyyy" selected={endDate} onChange={(date) => setEndDate(date)} />
