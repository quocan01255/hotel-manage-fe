...
const BookingInfo = () => {
  ...
  return (
    <div className="booking-info-container">
      <h2 className="c-booking-title" style={{ fontSize: "22px", textAlign:"center" }}>
        Complete your booking
      </h2>
      <div className="c-booking-price" style={{color:"#279EFF",fontWeight:"bold",fontSize:"17px",textAlign:"center"}}>
...
//     if (formData.cardNumber && !/^\d{5}$/.test(formData.cardNumber)) {
...
const Result1 = () => (
  <Result
    ...
    subTitle=""
    extra={[
      <Link to="/bookingpage" type="primary" key="console">
        <Button type="primary">Back Booking</Button>       
      </Link>,
