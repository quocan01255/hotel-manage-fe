        ...
        <div className="container">
            ...
            <div className="row mt-5 mb-5  bg-muted  "  style={{display: 'flex', justifyContent: 'center'}}>
                ...
                <div className="col-sm-6 ">
                    <img src="https://quynhon.maiaresorts.com/wp-content/uploads/2020/06/Explore.svg" alt="" width="20%" />

                    <h3 className="display-4 mt-2 pt-2">Beautiful & untouched
                        Quy Nhon</h3>
            ...
            <div className="row">
                ...
                <div className="col-sm-7">
                    <img src="https://quynhon.maiaresorts.com/wp-content/uploads/2020/08/Banh-It-Tower_resize.jpg" alt="" width="100%" />
                </div>
            </div>
            ...
            <div className="row mt-5 mb-5 pt-5 pb-5">
                ...
                <div className="col-sm-7">
                    <img src="https://quynhon.maiaresorts.com/wp-content/uploads/2020/08/DJI_0789_resize.jpg" alt="" width="100%" />
                </div>
            </div>
            ...
            <div className="row mt-5 mb-5 pt-5 pb-5">
                ...
                <div className="col-sm-7">
                    <img src="https://quynhon.maiaresorts.com/wp-content/uploads/2020/08/Hon-Kho-island_resize.jpg" alt="" width="100%" />
                </div>
            </div>
            ...
            <div className="row mt-5 mb-5 pt-5 pb-5">
                ...
                <div className="col-sm-7">
                    <img src="https://quynhon.maiaresorts.com/wp-content/uploads/2020/06/food-exploration-scaled.jpg" alt="" width="100%" />
                </div>
            </div>
