  ...
  return (
    <div>
      <Breadcrumb className='breadcrumb'>
        ...
        <Breadcrumb.Item className='breadcrumbItem'>Deluxe Pool</Breadcrumb.Item>
      </Breadcrumb>
      <Divider orientation='left' className='divider-admin-room-manager'>Deluxe Pool</Divider>
